<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'almacen',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>50)))); ?>

		<?php echo $form->textFieldGroup($model,'direccion',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>50)))); ?>

		<?php echo $form->textFieldGroup($model,'ubicacion_id',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
