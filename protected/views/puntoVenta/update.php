...
$this->breadcrumbs=array(
	...
	array('label'=>yii::t('app','Create').' '.yii::t('app','PuntoVenta'),'url'=>array('create')),
        array('label'=>yii::t('app','View').' '.yii::t('app','PuntoVenta'),'url'=>array('view','id'=>$model->id)),
        array('label'=>yii::t('app','Manage').' '.yii::t('app','PuntoVenta'),'url'=>array('admin')),
	);
	?>

	<h1> <?php echo yii::t('app','Update');?> <?php echo yii::t('app','PuntoVenta');?> <?php echo $model->id; ?></h1>
