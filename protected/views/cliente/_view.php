<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('nombre_rz')); ?>:</b>
	<?php echo CHtml::encode($data->nombre_rz); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('linea_credito')); ?>:</b>
