<?php $form=$this->beginWidget('booster.widgets.TbActiveForm',array(
	...
	'method'=>'get',
		...
		<?php echo $form->textFieldGroup($model,'movimiento',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>50)))); ?>

		<?php echo $form->textFieldGroup($model,'tipo_movimiento',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5')))); ?>
