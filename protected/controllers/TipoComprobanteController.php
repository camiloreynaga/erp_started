...
{
$dataProvider=new CActiveDataProvider('TipoComprobante');
...
if(isset($_GET['TipoComprobante']))
$model->attributes=$_GET['TipoComprobante'];
...
{
$model=TipoComprobante::model()->findByPk($id);
if($model===null)
