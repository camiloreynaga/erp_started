...
class TipoProductoController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('TipoProducto');
	...
	{
		$model=new TipoProducto('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TipoProducto']))
			$model->attributes=$_GET['TipoProducto'];
	 ...
	 * @param TipoProducto $model the model to be validated
	 */
