 ...
 */
class Color extends Erp_startedActiveRecord// CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, color, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'colorProducts' => array(self::HAS_MANY, 'ColorProduct', 'color_id'),
		);
	}
