...
class Caracteristica extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('caracteristica', 'length', 'max'=>50),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, caracteristica, activo, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'r_caracteristicaProductos' => array(self::HAS_MANY, 'CaracteristicaProducto', 'caracteristica_id'),
		);
	}
