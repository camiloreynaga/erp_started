 ...
 *
 * The followings are the available columns in table 'tbl_tipo_producto':
 * @property integer $id
...
class TipoProducto extends Erp_startedActiveRecord//CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, tipo_producto, activo, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'r_productos' => array(self::HAS_MANY, 'Producto', 'tipo_producto_id'),
		);
	}
